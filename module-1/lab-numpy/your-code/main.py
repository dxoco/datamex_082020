...
b = np.random.randint(1,10,[5,2,3])
...
"""
print(a+b)
It is not possible to add a +b due to their having different shapes.
"""
...
if a.shape == e.shape:
    ...
    print(False)
"""In shape they are equal, that would be due to matrix multiplication stuff"""
